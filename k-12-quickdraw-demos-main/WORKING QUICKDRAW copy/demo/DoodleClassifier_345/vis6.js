...
//  select('#heading2').html("Filters");
 ...
 async function renderImage(container, tensor, imageOpts,textP) {
   ...
   //document.getElementById("filter card").style.visibility="hidden";
    const childs =document.getElementById(container); 
    
   // const img=tf.browser.toPixels(resized)
   ...
   // const ctx = canvas.getContext('2d');
    ...
    //document.getElementById("filter card").style.backgroundColor="#fff";
